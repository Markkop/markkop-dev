export const siteConfig = {
  name: 'markkop.dev',
  title: 'Marcelo "Mark" Kopmann — Software Engineer | markkop.dev',
  description:
    'Marcelo "Mark" Kopmann builds practical web, AI, gamified, open-source, and onchain products from Santa Catarina, Brazil.',
