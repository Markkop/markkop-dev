...
export const content: Record<Language, SiteContent> = {
  en: {
    ...
    projects: {
      ...
      title: 'Projects that',
      titleHighlight: 'left the terminal.',
  ...
  'pt-BR': {
    ...
    about: {
      ...
      titleHighlight: 'do terminal.',
      stats: ['Repositórios públicos', 'Seguidores no GitHub', 'Anos no GitHub', 'Estrelas no principal projeto'],
      cards: [
        { label: '// O PORQUÊ', title: 'Por que eu crio', text: 'Gosto de transformar ideias vagas em produtos reais que as pessoas podem usar. Os melhores projetos ensinam algo, reduzem atrito ou tornam uma rotina mais recompensadora.' },
        { label: '// COMO EU PENSO', title: 'Como eu trabalho', text: 'Entrego um núcleo útil, aprendo com ele e então refino a experiência. Valorizo sistemas claros, bons ciclos de feedback e código que continua fácil de entender.' },
        { label: '// ALÉM DO CÓDIGO', title: 'O que desperta minha curiosidade', text: 'Gamificação, open source, incentivos onchain, fluxos assistidos por IA, ferramentas para comunidades e os pequenos detalhes que fazem o software parecer vivo.' },
      ],
      journey: '// JORNADA',
    ...
    projects: {
      ...
      title: 'Projetos que',
      titleHighlight: 'saíram do terminal.',
