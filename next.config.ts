...
const securityPolicy = [
  ...
  "img-src 'self' data: https://res.cloudinary.com https://secure.meetupstatic.com https://i.imgur.com https://github.com https://user-images.githubusercontent.com https://raw.githubusercontent.com",
  "font-src 'self' data:",
  "object-src 'none'",
  "base-uri 'self'",
  "form-action 'self'",
